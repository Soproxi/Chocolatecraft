...
@Mod(ChocolateCraft.MOD_ID)
public class ChocolateCraft
{
    public static final String MOD_ID = "chocolatecraft";
    public static final String MOD_NAME = "ChocolateCraft";
    ...
    public static class ChocolateCraftGroup extends ItemGroup {
        ...
        public ItemStack createIcon() {
            return ModItems.MILK_CHOCOLATE_BAR.get().getDefaultInstance();
        }
    }
